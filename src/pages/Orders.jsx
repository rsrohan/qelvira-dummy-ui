            ...
            <tbody className="divide-y divide-slate-100">
              {orders.map((o) => (
                <tr key={o.id}>
                  ...
                  <td className="px-5 py-3 text-slate-500">{o.items} items</td>
                  <td className="px-5 py-3 text-slate-900">₹{o.total.toLocaleString("en-IN")}</td>
                  <td className="px-5 py-3 text-slate-500">{o.eta}</td>
            ...
            <tbody className="divide-y divide-slate-100">
              {invoices.map((inv) => (
                <tr key={inv.id}>
                  ...
                  <td className="px-5 py-3 text-slate-500">{inv.order}</td>
                  <td className="px-5 py-3 text-slate-500">{inv.date}</td>
                  <td className="px-5 py-3 text-slate-900">₹{inv.amount.toLocaleString("en-IN")}</td>
                  <td className="px-5 py-3">
